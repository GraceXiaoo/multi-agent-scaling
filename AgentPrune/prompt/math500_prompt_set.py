...
ROLE_DESCRIPTION = {
    "Math Solver": 
        ...
        "The last line of your output contains only the final result without any units, and the result should be enclosed within $\\boxed{}$,for example: The answer is $\\boxed{xx}$\n"
...
@PromptSetRegistry.register('math500')
